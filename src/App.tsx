...
import {
  Check, CheckCircle2, ChevronDown, Gift, Instagram, Menu, Phone, Send,
  Sparkles, X, XCircle,
} from 'lucide-react'
...
function Header() {
  ...
  return <header className="header">
    <div className="container header-inner">
      ...
      <div className="header-actions"><a className="phone" href="tel:+79529447419"><Phone size={17} /> +7 (952) 944-74-19</a><a className="btn small" href="#certificate">Забрать сертификат</a></div>
...
export default function App() {
  return <><Header /><main id="top">
    <section className="hero"><div className="container hero-grid"><div className="hero-photo"><img src={realPhotos[4]} alt="Настоящий праздник Mister Teen" /></div><div className="hero-copy"><p className="eyebrow">Детские праздники под ключ</p><h1><span>MISTER TEEN</span><br />возвращается</h1><p className="hero-sub">И снова создаёт детские праздники под ключ <b>в Новосибирске</b> — ярко, весело и без хлопот.</p><div className="hero-buttons"><a className="btn" href="#certificate">Забрать сертификат</a><a className="btn outline" href="#certificate"><Gift /> Получить 10 000 бонусных рублей</a></div></div></div></section>
